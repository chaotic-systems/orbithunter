...
__all__ = ['integrate', 'fpo_dictionary']
...
def fpo_dictionary(tileset='default', comoving=False, rescaled=False):
    ...
    if tileset == 'padded':
        ...
        directory = os.path.abspath(os.path.join(__file__, '../../../data/tiles/space_padded/'))
    elif tileset == 'padded_time':
        directory = os.path.abspath(os.path.join(__file__, '../../../data/tiles/time_padded/'))
    elif tileset == 'resized':
        directory = os.path.abspath(os.path.join(__file__, '../../../data/tiles/resized/'))
    elif tileset == 'complete':
        directory = os.path.abspath(os.path.join(__file__, '../../../data/tiles/resized/'))
    else:
    ...
    if comoving:
        ...
        merger = _read_h5('./OrbitKS_merger_comoving.h5', directory=directory, basis='field')
    else:
        # padded merger Orbit in comoving frame
        merger = _read_h5('./OrbitKS_merger.h5', directory=directory, basis='field')

    # padded streak orbit
    streak = _read_h5('./OrbitKS_streak.h5', directory=directory, basis='field')

    # padded wiggle orbit
    wiggle = _read_h5('./OrbitKS_wiggle.h5', directory=directory, basis='field')
